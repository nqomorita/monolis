...
void monolis_matvec_c_test_R_V_nodal_graph(){
  MONOLIS mat;
  MONOLIS_COM com;
  int i;
  int n_node;
  ...
  monolis_std_log_string("monolis_matvec_c_test_R_V_nodal_graph");

  n_node = 5;

  /* nodal graph for chain mesh 0-1-2-3-4 (self + neighbors, sorted) */
  index = monolis_alloc_I_1d(index, n_node + 1);
  index[0] =  0;
  index[1] =  2;
  index[2] =  5;
  index[3] =  8;
  ...
  item = monolis_alloc_I_1d(item, 13);
  item[ 0] = 0; item[ 1] = 1;
  item[ 2] = 0; item[ 3] = 1; item[ 4] = 2;
  item[ 5] = 1; item[ 6] = 2; item[ 7] = 3;
  item[ 8] = 2; item[ 9] = 3; item[10] = 4;
  item[11] = 3; item[12] = 4;
  ...
  monolis_get_nonzero_pattern_by_nodal_graph_V_R(&mat, n_node, n_dof_list, index, item);
   ...
   * ry[6] = 1*5 + 2*7                   = 19
   */
  monolis_test_check_eq_R1("monolis_matvec_c_test_R_V_nodal_graph", ry[0],  4.0);
  monolis_test_check_eq_R1("monolis_matvec_c_test_R_V_nodal_graph", ry[1], 17.0);
  monolis_test_check_eq_R1("monolis_matvec_c_test_R_V_nodal_graph", ry[2],  9.0);
  monolis_test_check_eq_R1("monolis_matvec_c_test_R_V_nodal_graph", ry[3], 30.0);
  monolis_test_check_eq_R1("monolis_matvec_c_test_R_V_nodal_graph", ry[4], 49.0);
  monolis_test_check_eq_R1("monolis_matvec_c_test_R_V_nodal_graph", ry[5], 24.0);
  monolis_test_check_eq_R1("monolis_matvec_c_test_R_V_nodal_graph", ry[6], 19.0);
...
void monolis_matvec_c_test(){
  ...
  monolis_matvec_c_test_R_V_nodal_graph();
