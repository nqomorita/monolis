...
SRC_LIST_UTIL = def_prm.f90 def_mat.f90 def_com.f90 util.f90
#fillin.f90
SRC_LIST_ALGO = linalg_com.f90 linalg_util.f90 linalg.f90 matvec.f90 converge.f90 scaling.f90 restruct.f90 reorder.f90
SRC_LIST_PREC = 33/diag_33.f90 nn/diag_nn.f90 diag.f90 ilu.f90 precond.f90
...
SRC_LIST    = $(addprefix util/, $(SRC_LIST_UTIL)) $(addprefix linalg/, $(SRC_LIST_ALGO)) $(addprefix precond/, $(SRC_LIST_PREC)) $(addprefix direct/, $(SRC_LIST_DIRC)) $(addprefix iterative/, $(SRC_LIST_ITER)) $(addprefix main/, $(SRC_LIST_LIB)) $(addprefix main/, $(SRC_LIST_MAIN))
SRC_LIST_AR = $(addprefix util/, $(SRC_LIST_UTIL)) $(addprefix linalg/, $(SRC_LIST_ALGO)) $(addprefix precond/, $(SRC_LIST_PREC)) $(addprefix direct/, $(SRC_LIST_DIRC)) $(addprefix iterative/, $(SRC_LIST_ITER)) $(addprefix main/, $(SRC_LIST_LIB))
