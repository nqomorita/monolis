...
contains
  ...
  subroutine monolis_solver_DeflatedCG1(monoPRM, monoCOM, monoMAT, monoPREC)
    ...
    print *, "my_rank", monolis_mpi_get_global_my_rank(), "M", M
    print *, "my_rank", monolis_mpi_get_global_my_rank(), "M_neib", M_neib
    ...
    do iter = 1, monoPRM%Iarray(monolis_prm_I_max_iter)
      ...
      if(is_sparse_W)then
        call deflatedCG_P_coarse(monoPRM_deflated_eq, monoCOM_deflated_eq, monoMAT_deflated_eq, monoPRE_deflated_eq, &
