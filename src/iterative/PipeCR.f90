...
contains
  ...
  subroutine monolis_solver_PipeCR(monoPRM, monoCOM, monoMAT, monoPREC)
    ...
    do iter = 1, monoPRM%Iarray(monolis_prm_I_max_iter)
      ...
      call monolis_inner_product_main_R_no_comm(NNDOF, V, U, CG(1))
      call monolis_inner_product_main_R_no_comm(NNDOF, V, M, CG(2))
      call monolis_inner_product_main_R_no_comm(NNDOF, U, U, CG(3))
