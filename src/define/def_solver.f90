...
contains
  ...
  subroutine monolis_prm_initialize(monoPRM)
    ...
    monoPRM%monolis_prm_Iarray(monolis_prm_is_scaling) = 0
    monoPRM%monolis_prm_Iarray(monolis_prm_is_reordering) = 0
    monoPRM%monolis_prm_Iarray(monolis_prm_is_init_x) = 1
    monoPRM%monolis_prm_Iarray(monolis_prm_is_sym_matrix) = 0
    monoPRM%monolis_prm_Iarray(monolis_prm_is_debug) = 0
    monoPRM%monolis_prm_Iarray(monolis_prm_is_measurement) = 0
    monoPRM%monolis_prm_Iarray(monolis_prm_is_check_diag) = 0
    monoPRM%monolis_prm_Iarray(monolis_prm_is_prec_stored) = 0
    monoPRM%monolis_prm_Iarray(monolis_prm_show_iterlog) = 1
    monoPRM%monolis_prm_Iarray(monolis_prm_show_time) = 1
    monoPRM%monolis_prm_Iarray(monolis_prm_show_summary) = 1
    monoPRM%monolis_prm_Iarray(monolis_prm_show_time_statistics) = 0
