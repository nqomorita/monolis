...
contains
  ...
  subroutine monolis_solver_PipeBiCGSTAB(monoPRM, monoCOM, monoMAT)
    ...
    call monolis_matvec(monoCOM, monoMAT, RT, W0, monoPRM%tspmv, monoPRM%tcomm)
    call monolis_precond_apply(monoPRM, monoCOM, monoMAT, W0, WT)
    call monolis_matvec(monoCOM, monoMAT, WT, T, monoPRM%tspmv, monoPRM%tcomm)
    call monolis_inner_product_R(monoCOM, N, NDOF, R, R , RR, monoPRM%tdotp, monoPRM%tcomm)
    call monolis_inner_product_R(monoCOM, N, NDOF, R, W0, RW, monoPRM%tdotp, monoPRM%tcomm)
    ...
    do iter = 1, monoPRM%maxiter
      ...
      call monolis_matvec(monoCOM, monoMAT, ZT, V, monoPRM%tspmv, monoPRM%tcomm)
      ...
      call monolis_inner_product_R(monoCOM, N, NDOF, R0, W0, CG(2), monoPRM%tdotp, monoPRM%tcomm)
