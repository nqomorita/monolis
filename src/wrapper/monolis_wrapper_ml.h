...
extern void monolis_ml_get_nlocal_(int *nlocal, int *nlocal_allcolumns, int *ierr);

extern void monolis_ml_getrow_nn_(int *n_requested_rows,
                                int *requested_rows, int *allocated_space,
                                int *cols, double *values, int *row_lengths,
                                int *ierr);

extern void monolis_ml_matvec_nn_(int *in_length, double *p,
                                int *out_length, double *ap, int *ierr);

extern void monolis_ml_comm_nn_(double *x, int *ierr);
