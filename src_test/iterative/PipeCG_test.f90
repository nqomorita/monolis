!> PipeCG 法テストモジュール
module mod_monolis_solver_PipeCG_test
  use mod_monolis
...
contains
  ...
  subroutine monolis_solver_PipeCG_test()
    implicit none
    integer(kint) :: n_dof

    do n_dof = 1, 3
      call monolis_solver_PipeCG_test_main(n_dof, monolis_prec_NONE)
      call monolis_solver_PipeCG_test_main(n_dof, monolis_prec_DIAG)
      call monolis_solver_PipeCG_test_main(n_dof, monolis_prec_SOR)
      call monolis_solver_PipeCG_test_main(n_dof, monolis_prec_LU)
    enddo
  end subroutine monolis_solver_PipeCG_test

  subroutine monolis_solver_PipeCG_test_main(n_dof, prec)
    implicit none
    ...
    call monolis_std_global_log_string("monolis_solver_PipeCG")
    ...
    call monolis_set_method(mat, monolis_iter_PipeCG)
    ...
    call monolis_test_check_eq_R("monolis_solver_PipeCG_test_main", a, b)

    call monolis_finalize(mat)
  end subroutine monolis_solver_PipeCG_test_main

end module mod_monolis_solver_PipeCG_test
