!> BiCGStab_N128 法テストモジュール
module mod_monolis_solver_BiCGSTAB_N128_test
  use mod_monolis
...
contains
  ...
  subroutine monolis_solver_BiCGSTAB_N128_test()
    implicit none
    integer(kint) :: n_dof
  ...
  subroutine monolis_solver_BiCGSTAB_N128_test_main(n_dof, prec)
    implicit none
    ...
    call monolis_test_check_eq_R("monolis_solver_BiCGSTAB_N128_test_main", a, b)

    call monolis_finalize(mat)
  end subroutine monolis_solver_BiCGSTAB_N128_test_main
end module mod_monolis_solver_BiCGSTAB_N128_test
