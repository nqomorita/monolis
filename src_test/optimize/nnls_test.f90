...
contains
  ...
  subroutine monolis_optimize_nnls_test()
    ...
    call monolis_optimize_nnls_R(A, b, x, 4, 2, max_iter, tol, residual, COM_self)
    ...
    call monolis_optimize_nnls_R_with_sparse_solution(A, b, x, 4, 2, max_iter, tol, residual, COM_self)
    ...
    call monolis_optimize_nnls_R(A(1:3,1:2), b(1:3), x(1:2), 3, 2, max_iter, tol, residual, COM_self)
    ...
    call monolis_optimize_nnls_R_with_sparse_solution(A(1:3,1:2), b(1:3), x(1:2), 3, 2, max_iter, tol, residual, COM_self)
