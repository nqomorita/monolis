...
contains
  ...
  subroutine monolis_linalg_test()
    ...
    call monolis_std_global_log_string("monolis_inner_product_R_N128")
    call monolis_std_global_log_string("monolis_inner_product_V_I")
    call monolis_std_global_log_string("monolis_inner_product_V_R")
    call monolis_std_global_log_string("monolis_inner_product_V_C")
    ...
    call monolis_inner_product_V_I(monolis, com, n, ndof, iX, iY, isum)
    ...
    call monolis_inner_product_V_R(monolis, com, n, ndof, rX, rY, rsum)
    ...
    call monolis_inner_product_V_C(monolis, com, n, ndof, cX, cY, csum)
