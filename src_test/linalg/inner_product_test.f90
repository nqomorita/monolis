...
contains
  ...
  subroutine monolis_linalg_test()
    ...
    call monolis_inner_product_V_I(com, n*ndof, iX, iY, isum)
    ...
    call monolis_inner_product_V_R(com, n*ndof, rX, rY, rsum)
    ...
    call monolis_inner_product_V_C(com, n*ndof, cX, cY, csum)
